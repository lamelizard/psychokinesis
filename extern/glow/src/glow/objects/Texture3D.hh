...
public: // getter
    ...
    glm::ivec3 getDimensions() const override { return { mWidth, mHeight, mDepth }; }
...
public: // static construction
    ...
    static SharedTexture3D create(SizeT size, GLenum internalFormat = GL_RGBA) { return create(size.x, size.y, size.z, internalFormat); }
    ...
    static SharedTexture3D createStorageImmutable(SizeT size, GLenum internalFormat, int mipmapLevels = 0) { return createStorageImmutable(size.x, size.y, size.z, internalFormat, mipmapLevels); }
