...
public: // static construction
    ...
    static SharedTextureCubeMapArray create(SizeT size, GLenum internalFormat = GL_RGBA) { return create(size.x, size.y, size.z, internalFormat); }
    ...
    static SharedTextureCubeMapArray createStorageImmutable(SizeT size, GLenum internalFormat, int mipmapLevels = 0) { return createStorageImmutable(size.x, size.y, size.z, internalFormat, mipmapLevels); }
