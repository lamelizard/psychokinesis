...
public:
    ...
    struct BoundTexture2DMultisample
    {
        ...
        void resize(SizeT size, int samples = 4, GLboolean fixedSamples = GL_FALSE) { resize(size.x, size.y, samples, fixedSamples); }
...
public: // static construction
    ...
    static SharedTexture2DMultisample create(SizeT size, GLenum internalFormat = GL_RGBA) { return create(size.x, size.y, internalFormat); }
    ...
    static SharedTexture2DMultisample createStorageImmutable(SizeT size, GLenum internalFormat) { return createStorageImmutable(size.x, size.y, internalFormat); }
