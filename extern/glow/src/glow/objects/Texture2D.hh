...
public: // static construction
    ...
    static SharedTexture2D create(SizeT size, GLenum internalFormat = GL_RGBA) { return create(size.x, size.y, internalFormat); }
    ...
    static SharedTexture2D createStorageImmutable(SizeT size, GLenum internalFormat, int mipmapLevels = 0) { return createStorageImmutable(size.x, size.y, internalFormat, mipmapLevels); }
