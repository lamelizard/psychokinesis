...
public:
    ...
    struct BoundTexture2DMultisampleArray
    {
        ...
        void resize(SizeT size, int samples = 4, GLboolean fixedSamples = GL_FALSE) { resize(size.x, size.y, size.z, samples, fixedSamples); }
...
public: // static construction
    ...
    static SharedTexture2DMultisampleArray create(SizeT size, GLenum internalFormat = GL_RGBA) { return create(size.x, size.y, size.z, internalFormat); }
