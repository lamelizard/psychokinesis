...
public: // static construction
    ...
    static SharedTextureCubeMap create(SizeT size, GLenum internalFormat = GL_RGBA) { return create(size.x, size.y, internalFormat); }
    ...
    static SharedTextureCubeMap createStorageImmutable(SizeT size, GLenum internalFormat, int mipmapLevels = 0) { return createStorageImmutable(size.x, size.y, internalFormat, mipmapLevels); }
