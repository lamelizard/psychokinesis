...
BoundElementArrayBuffer* ElementArrayBuffer::getCurrentBuffer()
{
...
void BoundElementArrayBuffer::setIndices(const std::vector<int8_t>& indices, GLenum usage)
{
    setIndices(indices.size(), indices.data(), usage);
}

void BoundElementArrayBuffer::setIndices(const std::vector<uint8_t>& indices, GLenum usage)
{
    setIndices(indices.size(), indices.data(), usage);
}

void BoundElementArrayBuffer::setIndices(const std::vector<int16_t>& indices, GLenum usage)
{
    setIndices(indices.size(), indices.data(), usage);
}

void BoundElementArrayBuffer::setIndices(const std::vector<uint16_t>& indices, GLenum usage)
{
    setIndices(indices.size(), indices.data(), usage);
}

void BoundElementArrayBuffer::setIndices(const std::vector<int32_t>& indices, GLenum usage)
{
    setIndices(indices.size(), indices.data(), usage);
}

void BoundElementArrayBuffer::setIndices(const std::vector<uint32_t>& indices, GLenum usage)
{
    setIndices(indices.size(), indices.data(), usage);
}

void BoundElementArrayBuffer::setIndices(int indexCount, const int8_t* data, GLenum usage)
{
    setIndices(indexCount, GL_UNSIGNED_BYTE, data, usage);
}

void BoundElementArrayBuffer::setIndices(int indexCount, const uint8_t* data, GLenum usage)
{
    setIndices(indexCount, GL_UNSIGNED_BYTE, data, usage);
}

void BoundElementArrayBuffer::setIndices(int indexCount, const int16_t* data, GLenum usage)
{
    setIndices(indexCount, GL_UNSIGNED_SHORT, data, usage);
}

void BoundElementArrayBuffer::setIndices(int indexCount, const uint16_t* data, GLenum usage)
{
    setIndices(indexCount, GL_UNSIGNED_SHORT, data, usage);
}

void BoundElementArrayBuffer::setIndices(int indexCount, const int32_t* data, GLenum usage)
{
    setIndices(indexCount, GL_UNSIGNED_INT, data, usage);
}

void BoundElementArrayBuffer::setIndices(int indexCount, const uint32_t* data, GLenum usage)
{
    setIndices(indexCount, GL_UNSIGNED_INT, data, usage);
}

void BoundElementArrayBuffer::setIndices(int indexCount, GLenum indexType, const void* data, GLenum usage)
{
    if (!isCurrent())
        return;
...
BoundElementArrayBuffer::BoundElementArrayBuffer(ElementArrayBuffer* buffer) : buffer(buffer)
{
