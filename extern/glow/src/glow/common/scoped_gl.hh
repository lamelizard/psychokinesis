 ...
 *
 * New / convenience versions:
 *   scoped::wireframe name(true);
 *
...
struct clearColor
{
    ...
    clearColor(glm::vec3 const& c) : clearColor(c.r, c.g, c.b, 1.0f) {}
    clearColor(glm::vec4 const& c) : clearColor(c.r, c.g, c.b, c.a) {}
...
struct blendColor
{
    ...
    blendColor(glm::vec3 const& c) : blendColor(c.r, c.g, c.b, 1.0f) {}
    blendColor(glm::vec4 const& c) : blendColor(c.r, c.g, c.b, c.a) {}
...
struct colorMask
{
    ...
    colorMask(glm::vec3 const& c) : colorMask(c.r, c.g, c.b, 1.0f) {}
    colorMask(glm::vec4 const& c) : colorMask(c.r, c.g, c.b, c.a) {}
...
struct polygonMode
{
    ...
    ~polygonMode() { glPolygonMode(GL_FRONT_AND_BACK, prevMode[0]); }
};
